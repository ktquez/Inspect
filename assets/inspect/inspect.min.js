...
(function(window){
	...
	Inspect.prototype = {
		...
		prepareAlertError : function(obj, rule){
			...
			if (prevBlock) {
				block.style.zIndex = prevBlock.style.zIndex - 1;
			}
	...
	Inspect.prototype.utils = {	
		...
		animateScroll : function(interval){
			...
			var el = document.querySelector('.inspect-message'),
				offset = el.parentElement.getBoundingClientRect(),
				pos = window.scrollY - Math.abs(offset.top);	
